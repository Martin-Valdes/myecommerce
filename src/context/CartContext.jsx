...
const CartProvider = ({children}) =>{
    ...
    const costoTotal = () =>{
        return cart.reduce((all,newProduct)=>all+(newProduct.cantidad * newProduct.precio),0)
    }
    ...
    return(
        <CartContext.Provider value={{cart, addProduct, allArticle, deleteCart, deleteArticle, costoTotal}}>
            {children}
